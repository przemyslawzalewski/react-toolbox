...
var factory = function factory(ListItemContent, ListItemActions) {
  var ListItemLayout = function ListItemLayout(props) {
    ...
    var leftActions = [].concat(_toConsumableArray(props.leftActions));
    var rightActions = [].concat(_toConsumableArray(props.rightActions));
...
var ListItemLayout = factory(_ListItemContent2.default, _ListItemActions2.default);
