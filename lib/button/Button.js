...
var factory = function factory(ripple) {
    ...
    _createClass(Button, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            tagName = _props$tagName === undefined ? 'button' : _props$tagName,
            theme = _props.theme,
            buttonType = _props.type,
            others = _objectWithoutProperties(_props, ['accent', 'children', 'className', 'flat', 'floating', 'href', 'icon', 'inverse', 'label', 'mini', 'neutral', 'primary', 'raised', 'tagName', 'theme', 'type']);
        ...
        var buttonElement = _react2.default.createElement(element, props, icon, label, children);
  ...
  Button.propTypes = {
    ...
    tagName: _propTypes2.default.any,
...
var Button = factory((0, _Ripple2.default)({ centered: false }));
