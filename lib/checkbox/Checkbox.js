    ...
    _createClass(Checkbox, [{
      ...
      value: function render() {
        ...
        var _this$props = this.props,
            ...
            others = _objectWithoutProperties(_this$props, ["checked", "children", "disabled", "label", "name", "style", "onChange", "onMouseEnter", "onMouseLeave", "theme"]);

        var className = (0, _classnames2.default)(theme.field, _defineProperty({}, theme.disabled, this.props.disabled), this.props.className);
